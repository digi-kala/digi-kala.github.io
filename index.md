...
<p>
بالاخره گوشی من بعد حدود یک هفته فعال (رجیستر) شد.
گویا «باگ سیستم» برطرف گشت. از طرفی نیازی نبود «هر چند ساعت یکبار» همتا رو چک کنم.
خود همتا روز شنبه ۹بهمن حدود ساعت ۹ شب پیامک زد که گوشی قانونی شد و فعالسازی را انجام دهید. 
</p>

<table style="text-align:right;width:fit-content;">
<tr>
<td style="border-style: hidden">
  <a href="/assets/images/hamta-phone-registered.png" target="_blank">
  <img alt="hamta-phone-registered" src="/assets/images/hamta-phone-registered.png" style="width:60%;height:60%"/>
  </a>
</td>
<td style="border-style: hidden">
    با توجه به شکل:
  ...
  <ol>
    <li>پیام همتا مبنی بر غیرقانونی بودن گوشی و مهلت ۳۰ روزه</li>
    <li>اعلام همتا مبنی بر قانونی بودم گوشی و انجام فعالسازی</li>
    <li>پیام همتا بعد از فعالسازی</li>
  </ol>
</td>
</tr>
</table>
...
همین گوشی رو با همین گارانتی دیجی‌سرویس خریده و به همین مشکل برخورده
